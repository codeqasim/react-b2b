...
import {Box,InputAdornment,TextField,IconButton,Typography,Divider,Grid,Link,CardContent,CardMedia,CardActionArea,Card,ButtonGroup,Button} from '@mui/material/';
...
const cardImages = [
  ...
  return (
    ...
    InputProps={{
     ...
     <Typography gutterBottom fontSize='17px' fontWeight='700' lineHeight='22px'>
     ...
     <Box my={2}>
     <Divider sx={{ fontSize:'17px', fontWeight:700,lineHeight:'22px' }}>Shop By Category</Divider>
     </Box>
     ...
     {images.map((image) => (
      ...
      color:'transparent!important',
        ...
        <Box p={1} sx={{ backgroundColor:'#fff9d8',borderRadius:'20%', }}>
        <CardMedia
           component="img"
            alt={image.title}
           image={image.url}
         ...
         <CardContent sx={{ pb:'0px' }} >
           <Typography fontSize='16px' fontWeight='500' color='#222222' lineHeight='24px' >
            {image.name}
           </Typography>
         </CardContent>
       </CardActionArea>
